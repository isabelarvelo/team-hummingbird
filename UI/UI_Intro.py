...
def show_ai_assisted_labeling():
    ...
    st.write("""
        ...
        1. Upload Your Data: Use the upload button below to upload a CSV file containing your classroom transcripts. The file can be either labeled or unlabeled.
...
def main():
    ...
    # Other pages/functions can be added with additional buttons
